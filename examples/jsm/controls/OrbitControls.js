...
class OrbitControls extends EventDispatcher {
    ...
    constructor(object, domElement) {
        ...
        this.autoRotateSpeed = 20.0; // 30 seconds per orbit when fps is 60
        ...
        this.update = function() {
            ...
            return function update() {
                ...
                const time = Date.now() / 1000; // 毫秒转换为秒
                spherical.radius = 10 + Math.sin(time / 10) * 7;
