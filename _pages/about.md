...
I first explored this in systems research (OS internal mechanisms), then in HCI (human cognitive principles), and later in IoT and crowdsourcing (collective intelligence), before realizing that **Natural Language Processing (NLP)** is where I am most excited to pursue these questions. 
