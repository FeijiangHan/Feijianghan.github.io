    ...
    return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            ...
            function tinf_build_tree(e, t, n, r) {
                ...
                for (e.table[0] = 0, i = 0, s = 0; 16 > s; ++s) offs[s] = i, i += e.table[s];
            ...
            function tinf_decode_symbol(e, t) {
                ...
                var n = 0,
                    ...
                    s = 0,
                    i = e.tag;
                do r = 2 * r + (1 & i), i >>>= 1, ++s, n += t.table[s], r -= t.table[s]; while (r >= 0);
                return e.tag = i, e.bitcount -= s, t.trans[n + r]
            }

            function tinf_decode_trees(e, t, n) {
                var r, s, i, a, o, _;
                for (r = tinf_read_bits(e, 5, 257), s = tinf_read_bits(e, 5, 1), i = tinf_read_bits(e, 4, 4), a = 0; 19 > a; ++a) lengths[a] = 0;
                for (a = 0; i > a; ++a) {
            ...
            function tinf_inflate_block_data(e, t, n) {
                for (;;) {
                    ...
                    if (256 > r) e.dest[e.destLen++] = r;
                        ...
                        var s, i, a, o;
                        for (r -= 257, s = tinf_read_bits(e, length_bits[r], length_base[r]), i = tinf_decode_symbol(e, n), a = e.destLen - tinf_read_bits(e, dist_bits[i], dist_base[i]), o = a; a + s > o; ++o) e.dest[e.destLen++] = e.dest[o]
                    }
                }
            }
            ...
            function GlyphNames(e) {
                ...
                switch (e.version) {
                    case 1:
                        ...
                        break;
                    case 2:
                        for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++) this.names[l] = e.glyphNameIndex[l] < exports.standardNames.length ? exports.standardNames[e.glyphNameIndex[l]] : e.names[e.glyphNameIndex[l] - exports.standardNames.length];
                        break;
                    case 2.5:
                        for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++) this.names[l] = exports.standardNames[l + e.glyphNameIndex[l]];
                        break;
                    case 3:
                        this.names = []
                }
        ...
        5: [function(require, module, exports) {
            ...
            Font.prototype.hasChar = function(e) {
                ...
                for (var e = this.toTables(), t = e.encode(), n = new ArrayBuffer(t.length), i = new Uint8Array(n), r = 0; r < t.length; r++) i[r] = t[r];
                return n
        ...
        6: [function(require, module, exports) {
            ...
            Glyph.prototype.bindConstructorValues = function(t) {
                ...
                function a(i, e, n, a) {
                    var h = 2 * Math.PI;
                    t.beginPath();
                    for (var o = 0; o < i.length; o += 1) t.moveTo(e + i[o].x * a, n + i[o].y * a), t.arc(e + i[o].x * a, n + i[o].y * a, 2, 0, h, !1);
                    t.closePath(), t.fill()
                }
                ...
                Layout = {
                    ...
                    expandCoverage: function(e) {
                        ...
                        for (var r = [], t = e.ranges, a = 0; t > a; a++)
                            for (var s = t[a], n = s.start, u = s.end, i = n; u >= i; i++) r.push(i);
                        return r
                    }
                };
        ...
        9: [function(require, module, exports) {
            ...
            function parseBuffer(e) {
                var a, r, s, t = new _font.Font({
                        empty: !0
                    }),
                    n = new DataView(e, 0),
                    o = [],
                    p = parse.getTag(n, 0);
                if (p === String.fromCharCode(0, 1, 0, 0)) t.outlinesFormat = "truetype", s = parse.getUShort(n, 4), o = parseOpenTypeTableEntries(n, s);
                else if ("OTTO" === p) t.outlinesFormat = "cff", s = parse.getUShort(n, 4), o = parseOpenTypeTableEntries(n, s);
                else {
                    if ("wOFF" !== p) throw new Error("Unsupported OpenType signature " + p);
                    var l = parse.getTag(n, 4);
                    if (l === String.fromCharCode(0, 1, 0, 0)) t.outlinesFormat = "truetype";
                    else {
        ...
        10: [function(require, module, exports) {
            ...
            exports.getByte = function(t, r) {
                ...
                for (var e = "", s = r; r + 4 > s; s += 1) e += String.fromCharCode(t.getInt8(s));
                return e
            }, exports.getOffset = function(t, r, e) {
                for (var s = 0, a = 0; e > a; a += 1) s <<= 8, s += t.getUint8(r + a);
                return s
            }, exports.getBytes = function(t, r, e) {
                for (var s = [], a = r; e > a; a += 1) s.push(t.getUint8(a));
                return s
            }, exports.bytesToString = function(t) {
                for (var r = "", e = 0; e < t.length; e += 1) r += String.fromCharCode(t[e]);
                return r
            };
            var typeOffsets = {
                "byte": 1,
            ...
            Parser.prototype.parseByte = function() {
                ...
                for (var a = 0; t > a; a++) s += String.fromCharCode(r.getUint8(e + a));
                return s
                ...
                for (var r = new Array(t), e = this.data, s = this.offset + this.relativeOffset, a = 0; t > a; a++) r[a] = e.getUint16(s), s += 2;
                ...
                for (var r = this.parseOffset16List(), e = r.length, s = this.relativeOffset, a = new Array(e), o = 0; e > o; o++) {
                    ...
                    if (0 !== i)
                        if (this.relativeOffset = i, t) {
                            for (var n = this.parseOffset16List(), f = new Array(n.length), p = 0; p < n.length; p++) this.relativeOffset = i + n[p], f[p] = t.call(this);
                            a[o] = f
                ...
                if (2 === r) {
                    for (var s = new Array(e), a = 0; e > a; a++) s[a] = {
        ...
        12: [function(require, module, exports) {
            ...
            Substitution.prototype = Layout, Substitution.prototype.getGsubTable = function(t) {
                ...
                if (!s) return a;
                for (var o = s.subtables, u = 0; u < o.length; u++)
                    for (var i = o[u], n = this.expandCoverage(i.coverage), g = i.alternateSets, l = 0; l < n.length; l++) a.push({
                        sub: n[l],
                        by: g[l]
                    });
                return a
        ...
        13: [function(require, module, exports) {
            ...
            function ushortList(e, t, a) {
                ...
                for (var o = 0; o < t.length; o++) r[o + 1] = {
                    name: e + o,
                    type: "USHORT",
                    value: t[o]
                };
        ...
        14: [function(require, module, exports) {
            ...
            function parseCFFIndex(e, t, a) {
                ...
                if (0 !== h) {
                    ...
                    n = t + (h + 1) * f + 2;
                    var p = t + 3;
                    for (r = 0; h + 1 > r; r += 1) i.push(parse.getOffset(e, p, f)), p += f;
                    s = n + i[h]
                } else s = t + 2;
            ...
            function parseCFFCharset(e, t, a, r) {
                var n, s, i, o = new parse.Parser(e, t);
                a -= 1;
                var h = [".notdef"],
                    f = o.parseCard8();
                if (0 === f)
                    for (n = 0; a > n; n += 1) s = o.parseSID(), h.push(getCFFString(r, s));
                else if (1 === f)
                    for (; h.length <= a;)
                        for (s = o.parseSID(), i = o.parseCard8(), n = 0; i >= n; n += 1) h.push(getCFFString(r, s)), s += 1;
                else {
                    if (2 !== f) throw new Error("Unknown charset format " + f);
                    for (; h.length <= a;)
                        for (s = o.parseSID(), i = o.parseCard16(), n = 0; i >= n; n += 1) h.push(getCFFString(r, s)), s += 1
                }
                return h
            }
            ...
            function parseCFFEncoding(e, t, a) {
                ...
                if (0 === o) {
                    ...
                    var f = i.parseCard8();
                    for (n = 1, r = 0; f > r; r += 1)
                        for (var p = i.parseCard8(), u = i.parseCard8(), l = p; p + u >= l; l += 1) s[l] = n, n += 1
                }
                    ...
                    for (var y, b, C, T, F, I, D, x, k, S, E, O, R = 0; R < a.length;) {
                        ...
                        switch (R += 1, M) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                for (; u.length > 0;) v += u.shift(), m += u.shift(), p.lineTo(v, m);
                                break;
                            case 6:
                                for (; u.length > 0 && (v += u.shift(), p.lineTo(v, m), 0 !== u.length);) m += u.shift(), p.lineTo(v, m);
                                break;
                            case 7:
                                for (; u.length > 0 && (m += u.shift(), p.lineTo(v, m), 0 !== u.length);) v += u.shift(), p.lineTo(v, m);
                                break;
                            case 8:
                                for (; u.length > 0;) i = v + u.shift(), o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + u.shift(), p.curveTo(i, o, h, f, v, m);
                                break;
                            case 10:
                            ...
                            case 23:
                                ...
                                break;
                            case 24:
                                for (; u.length > 2;) i = v + u.shift(), o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + u.shift(), p.curveTo(i, o, h, f, v, m);
                                v += u.shift(), m += u.shift(), p.lineTo(v, m);
                                break;
                            case 25:
                                for (; u.length > 6;) v += u.shift(), m += u.shift(), p.lineTo(v, m);
                                i = v + u.shift(), o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + u.shift(), p.curveTo(i, o, h, f, v, m);
                                break;
                            case 26:
                                for (u.length % 2 && (v += u.shift()); u.length > 0;) i = v, o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h, m = f + u.shift(), p.curveTo(i, o, h, f, v, m);
                                break;
                            case 27:
                                for (u.length % 2 && (m += u.shift()); u.length > 0;) i = v + u.shift(), o = m, h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f, p.curveTo(i, o, h, f, v, m);
                                break;
                            case 28:
                            ...
                            case 29:
                                ...
                                break;
                            case 30:
                                for (; u.length > 0 && (i = v, o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + (1 === u.length ? u.shift() : 0), p.curveTo(i, o, h, f, v, m), 0 !== u.length);) i = v + u.shift(), o = m, h = i + u.shift(), f = o + u.shift(), m = f + u.shift(), v = h + (1 === u.length ? u.shift() : 0), p.curveTo(i, o, h, f, v, m);
                                break;
                            case 31:
                                for (; u.length > 0 && (i = v + u.shift(), o = m, h = i + u.shift(), f = o + u.shift(), m = f + u.shift(), v = h + (1 === u.length ? u.shift() : 0), p.curveTo(i, o, h, f, v, m), 0 !== u.length);) i = v, o = m + u.shift(), h = i + u.shift(), f = o + u.shift(), v = h + u.shift(), m = f + (1 === u.length ? u.shift() : 0), p.curveTo(i, o, h, f, v, m);
                                break;
                            default:
            ...
            function encodeString(e, t) {
                var a, r = encoding.cffStandardStrings.indexOf(e);
            ...
            function makeNameIndex(e) {
                ...
                t.names = [];
                for (var a = 0; a < e.length; a += 1) t.names.push({
                    name: "name_" + a,
                    type: "NAME",
                    value: e[a]
                });
            ...
            function makeStringIndex(e) {
                ...
                t.strings = [];
                for (var a = 0; a < e.length; a += 1) t.strings.push({
                    name: "string_" + a,
                    type: "STRING",
                    value: e[a]
                });
            ...
            function glyphToOps(e) {
                ...
                for (var r = 0, n = 0, s = 0; s < a.commands.length; s += 1) {
                    ...
                    else if ("L" === h.type) i = Math.round(h.x - r), o = Math.round(h.y - n), t.push({
                        name: "dx",
                        type: "NUMBER",
                        value: i
                    }), t.push({
            ...
            function makeCFFTable(e, t) {
                for (var a, r = new table.Table("CFF ", [{
                        ...
                        charStrings: 999,
                        "private": [0, 999]
                    }, i = {}, o = [], h = 1; h < e.length; h += 1) a = e.get(h), o.push(a.name);
                var f = [];
        ...
        15: [function(require, module, exports) {
            ...
            function parseCmapTableFormat12(e, a) {
                ...
                for (e.groupCount = t = a.parseULong(), e.glyphIndexMap = {}, r = 0; t > r; r += 1)
                    for (var n = a.parseULong(), s = a.parseULong(), o = a.parseULong(), l = n; s >= l; l += 1) e.glyphIndexMap[l] = o, o++
            }
            ...
            function parseCmapTableFormat4(e, a, r, t, n) {
                ...
                var l = new parse.Parser(r, t + n + 14),
                    ...
                    u = t + n + 16 + 8 * o;
                for (s = 0; o - 1 > s; s += 1)
                    for (var h, f = l.parseUShort(), c = p.parseUShort(), d = g.parseShort(), i = m.parseUShort(), v = c; f >= v; v += 1) 0 !== i ? (u = m.offset + m.relativeOffset - 2, u += i, u += 2 * (v - c), h = parse.getUShort(r, u), 0 !== h && (h = h + d & 65535)) : h = v + d & 65535, e.glyphIndexMap[v] = h
            }
            ...
            function parseCmapTable(e, a) {
                ...
                if (t.format = l.parseUShort(), 12 === t.format) parseCmapTableFormat12(t, l);
                else {
            ...
            function makeCmapTable(e) {
                ...
                for (r.segments = [], a = 0; a < e.length; a += 1) {
                    for (var t = e.get(a), n = 0; n < t.unicodes.length; n += 1) addSegment(r, t.unicodes[n], a);
        ...
        16: [function(require, module, exports) {
            ...
            function parseFvarInstance(e, a, r, n) {
                ...
                for (var u = 0; u < r.length; ++u) t.coordinates[r[u].tag] = s.parseFixed();
                return t
            }
            ...
            function makeFvarTable(e, a) {
                ...
                for (var n = 0; n < e.axes.length; n++) r.fields = r.fields.concat(makeFvarAxis(n, e.axes[n], a));
                for (var t = 0; t < e.instances.length; t++) r.fields = r.fields.concat(makeFvarInstance(t, e.instances[t], e.axes, a));
                return r
            }
            ...
            function parseFvarTable(e, a, r) {
                ...
                n.skip("uShort", 1);
                for (var u = n.parseUShort(), i = n.parseUShort(), p = n.parseUShort(), l = n.parseUShort(), v = [], o = 0; u > o; o++) v.push(parseFvarAxis(e, a + s + o * i, r));
                for (var m = [], f = a + s + u * i, c = 0; p > c; c++) m.push(parseFvarInstance(e, f + c * l, v, r));
                return {
                    axes: v,
                    instances: m
                }
        ...
        17: [function(require, module, exports) {
            ...
            function parseGlyph(e, r, t) {
                ...
                if (e.numberOfContours > 0) {
                    ...
                    for (s = 0; s < e.numberOfContours; s += 1) p.push(o.parseUShort());
                    ...
                    for (a = [], s = 0; i > s; s += 1)
                        if (n = o.parseByte(), a.push(n), (8 & n) > 0)
                            for (var h = o.parseByte(), l = 0; h > l; l += 1) a.push(n), s += 1;
                    if (check.argument(a.length === i, "Bad flags."), p.length > 0) {
                        var u, c = [];
                        if (i > 0) {
                            for (s = 0; i > s; s += 1) n = a[s], u = {}, u.onCurve = !!(1 & n), u.lastPointOfContour = p.indexOf(s) >= 0, c.push(u);
                            var y = 0;
                            for (s = 0; i > s; s += 1) n = a[s], u = c[s], u.x = parseGlyphCoordinate(o, n, y, 2, 16), y = u.x;
                            var f = 0;
                            for (s = 0; i > s; s += 1) n = a[s], u = c[s], u.y = parseGlyphCoordinate(o, n, f, 4, 32), f = u.y
                        }
                        e.points = c
                    } else e.points = []
                ...
                if (r.isComposite)
                    for (var t = 0; t < r.components.length; t += 1) {
                        ...
                        if (a.getPath(), a.points) {
                            var n;
                            if (void 0 === o.matchedPoints) n = transformPoints(a.points, o);
                            else {
            ...
            function parseGlyfTable(e, r, t, o) {
                var a, n = new glyphset.GlyphSet(o);
        ...
        18: [function(require, module, exports) {
            ...
            function parseTaggedListTable(r, e) {
                for (var a = new parse.Parser(r, e), s = a.parseUShort(), t = [], o = 0; s > o; o++) t[a.parseTag()] = {
            ...
            function parseCoverageTable(r, e) {
                ...
                if (2 === s) {
                    for (var o = []; t--;)
                        for (var p = a.parseUShort(), n = a.parseUShort(), f = a.parseUShort(), i = p; n >= i; i++) o[f++] = i;
                    return o
                }
            }
            ...
            function parseClassDefTable(r, e) {
                ...
                if (2 === s) {
                    for (var n = a.parseUShort(), f = [], i = [], h = [], S = 0; n > S; S++) f[S] = a.parseUShort(), i[S] = a.parseUShort(), h[S] = a.parseUShort();
                    return function(r) {
            ...
            function parsePairPosSubTable(r, e) {
                var a, s, t = new parse.Parser(r, e),
                    o = t.parseUShort(),
                    p = t.parseUShort(),
                ...
                if (4 === f && 0 === i) {
                    ...
                    if (2 === o) {
                        for (var b = t.parseUShort(), P = t.parseUShort(), L = t.parseUShort(), k = t.parseUShort(), d = parseClassDefTable(r, e + b), w = parseClassDefTable(r, e + P), O = [], C = 0; L > C; C++)
                            for (var G = O[C] = [], K = 0; k > K; K++) f && (a = t.parseShort()), i && (s = t.parseShort()), G[K] = a;
                        var V = {};
            ...
            function parseLookupTable(r, e) {
                ...
                if (2 === s) {
                    for (var i = [], h = 0; p > h; h++) i.push(parsePairPosSubTable(r, e + n[h]));
        ...
        25: [function(require, module, exports) {
            ...
            function parseLtagTable(e, a) {
                ...
                for (var n = r.parseULong(), s = [], l = 0; n > l; l++) {
                    for (var p = "", u = a + r.parseUShort(), g = r.parseUShort(), o = u; u + g > o; ++o) p += String.fromCharCode(e.getInt8(o));
                    s.push(p)
                }
                return s
            }
        ...
        28: [function(require, module, exports) {
            ...
            function makeNameTable(e, a) {
                ...
                for (var U = new table.Table("name", [{
                        ...
                        type: "USHORT",
                        value: 6 + 12 * u.length
                    }]), I = 0; I < u.length; I++) U.fields.push({
                    name: "record_" + I,
                    type: "RECORD",
                    value: u[I]
                });
            ...
            function parsePostTable(e, a) {
                ...
                switch (n.version = s.parseVersion(), n.italicAngle = s.parseFixed(), n.underlinePosition = s.parseShort(), n.underlineThickness = s.parseShort(), n.isFixedPitch = s.parseULong(), n.minMemType42 = s.parseULong(), n.maxMemType42 = s.parseULong(), n.minMemType1 = s.parseULong(), n.maxMemType1 = s.parseULong(), n.version) {
                    case 1:
                        ...
                        break;
                    case 2:
                        for (n.numberOfGlyphs = s.parseUShort(), n.glyphNameIndex = new Array(n.numberOfGlyphs), r = 0; r < n.numberOfGlyphs; r++) n.glyphNameIndex[r] = s.parseUShort();
                        ...
                        break;
                    case 2.5:
                        for (n.numberOfGlyphs = s.parseUShort(), n.offset = new Array(n.numberOfGlyphs), r = 0; r < n.numberOfGlyphs; r++) n.offset[r] = s.parseChar()
                }
                return n
            }
        ...
        31: [function(require, module, exports) {
            ...
            function computeCheckSum(e) {
                ...
                for (var a = 0, n = 0; n < e.length; n += 4) a += (e[n] << 24) + (e[n + 1] << 16) + (e[n + 2] << 8) + e[n + 3];
            ...
            function makeSfntTable(e) {
                ...
                for (var t = [], r = [], i = a.sizeOf() + makeTableRecord().sizeOf() * a.numTables; i % 4 !== 0;) i += 1, r.push({
                    name: "padding",
                    type: "BYTE",
                    value: 0
                });
                for (var s = 0; s < e.length; s += 1) {
                    ...
                    for (t.push({
                            ...
                            type: "RECORD",
                            value: l
                        }), i += u, check.argument(!isNaN(i), "Something went wrong calculating the offset."); i % 4 !== 0;) i += 1, r.push({
                        name: "padding",
                        type: "BYTE",
                        value: 0
                    })
        ...
        32: [function(require, module, exports) {
            ...
            encode.BYTE = function(e) {
                ...
                for (var n = [], t = 0; t < e.length; t += 1) n[t] = e.charCodeAt(t);
                return n
                ...
                i += 1 & i.length ? "f" : "ff";
                var f = [30];
                for (c = 0, r = i.length; r > c; c += 2) f.push(parseInt(i.substr(c, 2), 16));
                return f
                ...
                for (var o = [], c = t, r = 0; c > r; r++, n += 1) o[r] = e.getUint8(n);
                return String.fromCharCode.apply(null, o)
            }, decode.UTF16 = function(e, n, t) {
                for (var o = [], c = t / 2, r = 0; c > r; r++, n += 2) o[r] = e.getUint16(n);
                return String.fromCharCode.apply(null, o)
            ...
            var macEncodingTableCache = "function" == typeof WeakMap && new WeakMap,
                macEncodingCacheKeys, getMacEncodingTable = function(e) {
                    if (!macEncodingCacheKeys) {
                        macEncodingCacheKeys = {};
                        for (var n in eightBitMacEncodings) macEncodingCacheKeys[n] = new String(n)
                    }
                    ...
                    if (void 0 === c) return void 0;
                    for (var r = {}, i = 0; i < c.length; i++) r[c.charCodeAt(i)] = i + 128;
            ...
            encode.MACSTRING = function(e, n) {
                ...
                var t = [];
                if (Array.isArray(n))
                    for (var o = 0; o < n.length; o += 1) check.argument(e.length === n.length, "Not enough arguments given for type" + n), t = t.concat(encode.OPERAND(e[o], n[o]));
        ...
        33: [function(require, module, exports) {
            ...
            exports.isBrowser = function() {
                ...
                for (var e = new ArrayBuffer(r.length), n = new Uint8Array(e), t = 0; t < r.length; ++t) n[t] = r[t];
                return e
            }, exports.arrayBufferToNodeBuffer = function(r) {
                for (var e = new Buffer(r.byteLength), n = new Uint8Array(r), t = 0; t < e.length; ++t) e[t] = n[t];
                return e
