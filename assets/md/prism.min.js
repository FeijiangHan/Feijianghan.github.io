...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function(e) {
        var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            r = {
                    ...
                    clone: function e(t, a) {
                        ...
                        switch (a = a || {}, r.util.type(t)) {
                            case "Object":
                                ...
                                for (var i in n = {}, a[s] = n, t) t.hasOwnProperty(i) && (n[i] = e(t[i], a));
                                return n;
                            case "Array":
                                return s = r.util.objId(t), a[s] ? a[s] : (n = [], a[s] = n, t.forEach((function(t, r) {
                                    n[r] = e(t, a)
                                })), n);
                            default:
                                return t
                ...
                highlightElement: function(t, a, n) {
                    ...
                    function u(e) {
                        l.highlightedCode = e, r.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, r.hooks.run("after-highlight", l), r.hooks.run("complete", l), n && n.call(l.element)
                    }
                    if (r.hooks.run("before-sanity-check", l), (o = l.element.parentElement) && "pre" === o.nodeName.toLowerCase() && !o.hasAttribute("tabindex") && o.setAttribute("tabindex", "0"), !l.code) return r.hooks.run("complete", l), void(n && n.call(l.element));
                ...
                highlight: function(e, t, a) {
                    ...
                    if (r.hooks.run("before-tokenize", n), !n.grammar) throw new Error('The language "' + n.language + '" has no grammar.');
                    return n.tokens = r.tokenize(n.code, n.grammar), r.hooks.run("after-tokenize", n), s.stringify(r.util.encode(n.tokens), n.language)
                },
            ...
            for (var d in a)
                if (a.hasOwnProperty(d) && a[d]) {
                    ...
                    for (var m = 0; m < p.length; ++m) {
                        ...
                        for (var x = h.pattern || h, k = n.next, w = l; k !== t.tail && !(c && w >= c.reach); w += k.value.length, k = k.next) {
                            var A = k.value;
                            ...
                            if (!(A instanceof s)) {
                                ...
                                if (b) {
                                    ...
                                    for (var j = k; j !== t.tail && (_ < E || "string" == typeof j.value); j = j.next) $++, _ += j.value.length;
                                ...
                                var T = k.prev;
                                if (L && (T = u(t, T, L), w += L.length), g(t, T, $), k = u(t, T, new s(d, f ? r.tokenize(C, f) : C, y, C)), z && u(t, k, z), $ > 1) {
                                    var M = {
                                        cause: d + "," + m,
                                        reach: O
                                    };
                                    o(e, t, a, k.prev, w, M), c && M.reach > c.reach && (c.reach = M.reach)
                                }
                            }
                        }
                    }
        ...
        if (e.Prism = r, s.stringify = function e(t, a) {
        ...
        if (void 0 !== Prism && "undefined" != typeof document) {
            ...
            Prism.hooks.add("before-highlightall", (function(e) {
                    ...
                    c && c.loadLanguages(u),
                        function(e, t, a) {
                            ...
                            n.open("GET", e, !0), n.onreadystatechange = function() {
                                4 == n.readyState && (n.status < 400 && n.responseText ? t(n.responseText) : n.status >= 400 ? a("✖ Error " + n.status + " while fetching file: " + n.statusText) : a("✖ Error: File does not exist or is empty"))
                            }, n.send(null)
                        }(l, (function(e) {
                            i.setAttribute(t, n);
                            var a = function(e) {
                ...
                highlight: function(e) {
                    for (var t, a = (e || document).querySelectorAll(r), n = 0; t = a[n++];) Prism.highlightElement(t)
                }
            };
            var s = !1;
            Prism.fileHighlight = function() {
                s || (console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."), s = !0), Prism.plugins.fileHighlight.highlight.apply(this, arguments)
            }
        }
    }();
